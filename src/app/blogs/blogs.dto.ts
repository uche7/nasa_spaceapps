export const cards =[
    { imageSrc: 'https://i.imgur.com/QpmXELP.png', title: 'Card Grid Layout Card Grid Layout Card Grid Layout Card Grid Layout Card Grid Layout', description: 'Demo of pixel perfect pure CSS simple responsive card grid layout', slug: 'card-grid-layout-1' },
