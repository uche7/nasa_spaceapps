        ...
        <div className="w-[35.46%]">
          ...
          <div>
            <p className="mt-[13.3px] font-hackathoneSFProDisplay font-normal text-[18px] leading-[22.63px] text-slate-300">
              Join NASA Space Apps Athlone from<span className="font-extrabold text-hackathone-font-rocket-red "> October 4 to 6</span>,  <span className="font-bold text-[18px] text-white"> this year's theme is "The Sun Touches Everything". </span>
            </p>
          </div>
